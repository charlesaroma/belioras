  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="absolute left-1/2 top-full mt-1 w-full max-w-6xl -translate-x-1/2 origin-top rounded-xl border border-umber-50 bg-ivory-50/98 text-espresso shadow-large backdrop-blur"
      >
        <div className="flex gap-8 p-6 sm:p-8 md:p-10 justify-between">
