...
export default function DeleteCategoryModal({ open, onClose, category, onDelete }) {
  const handleDelete = () => {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-umber-50">
              <h2 className="text-lg font-semibold text-espresso">Delete Category</h2>
              <button
                type="button"
                onClick={onClose}
              ...
              <div className="flex items-start gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-espresso/60">
                    This action cannot be undone. This will permanently delete the category "{category?.name}" from your catalog.
                  </p>
                </div>
              </div>
                ...
                <div className="bg-umber-50/30 rounded-lg p-4 mb-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-espresso/60">ID: {category.id}</p>
                    </div>
                    <p className="text-sm font-semibold text-espresso">{category.productCount} products</p>
                  </div>
                </div>
              )}
